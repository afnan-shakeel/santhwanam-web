...
## Project Overview
This is an Angular 20 standalone application with signals-first state management, Tailwind CSS v4, and a modular architecture.
...
- Available shared components: badge, button, checkbox, input, radio-group, select
...
## AI-Specific Notes
- Place new UI references in `docs/ui-html-templates/` when provided
- Keep code ASCII and concise
- Avoid verbose explanations in code unless necessary for understanding
- Follow existing architectural patterns in the codebase
- When implementing features, check existing implementations first
